# Аналитическая лабораторная AWS. 7 вариант.
## Команда Вуха:
* Калачева Вера К3223
...
| Подвид S3 Glacier                        | Сервис для архивирования данных и долгосрочного резервного копирования с использованием хранилищ.                                                                                                                                                                                                                                            |
| Подвид S3 Standard-IA                    | Используется для долгосрочного хранения данных, резервного копирования, а также хранения данных на случай аварийного восстановления файлов.                                                                                                                                                                                                  |
| Подвид S3 One Zone-IA                    | Используется для хранения редко используемых данных и которым не нужна доступность и устойчивость.                                                                                                                                                                                                                                           |
...
4.  **Андата**  это платформа сбора и управления клиентскими данными (CDP + DMP), формирующая цифровые профили пользователей и позволяющая, с помощью машинного обучения (DML), эффективно управлять рекламными кампаниями в автоматическом режиме с помощью Андата Оптимайзера.

Подвиды:
* AI Оптимайзер - это сервис автоматически оптимизирует стоимость конверсий (в контекстной рекламе) до нужного результата при помощи машинного обучения;
* AI Аналитика -  это сервис предоставляющий готовые дашборды с объединенными данными из разных источников, что позволяет отслеживать эффективность маркетинговых усилий и принимать решения на основании данных;
* Data Hub позволяет подключить к Андата веб-сайты, мобильные приложения, CRM, рекламные кабинеты, системы аналитики, wi-fi, телефонию, чтобы собирать, обогащать и структурировать данные;
* Tag & Event Manager - это система управления тегами, которая позволяет настраивать и мгновенно внедрять элементы кода на сайте и в мобильном приложении с помощью интерфейса.

5. **Облачное объектное хранилище S3 (Selectel)** - сервис Selectel для хранения и раздачи неограниченного объема неструктурированных и полуструктурированных данных.
...
6. **Yandex Object Storage** позволяет:
...
7. **Сервис Yandex Data Transfer** предназначен для логического переноса данных между источниками и приемниками. В качестве источников и приемников данных могут выступать СУБД, объектные хранилища или брокеры сообщений.
...
## Вывод
В настоящее время на российском рынке представлено достаточное количество аналогов сервисов Amazon, однако зачастую функционал сервисов заметно различается. У многих сервисов есть точные аналоги в России, однако у некоторых сервисов достаточно похожего российского сервиса нет (например, AmazonMacie). Значительную роль на рынке играют такие компании, как Yandex, Selectel, Sber. Российские сервисы имеют хорошие перспективы развития в ближайшие несколько лет, чтобы полностью заместить иностранные сервисы.
